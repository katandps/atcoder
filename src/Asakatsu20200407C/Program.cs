...
using System.IO;
using System.Linq;
using static Asakatsu20200407C.Input;

namespace Asakatsu20200407C
{
    static class Input
    {
    ...
    class Solver
    {
        public void Solve()
        {
            ...
            foreach (var kv in count)
            {
                ...
                if (kv.Key > secondary && kv.Value >= 2)
                {
                    secondary = kv.Key;
                }
            }

            Console.WriteLine(first * secondary);
        }
    }
}