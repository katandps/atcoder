...
using System.IO;
using System.Linq;
using static Yorukatsu20200409C.Input;

namespace Yorukatsu20200409C
{
    static class Input
    {
        ...
        public void Solve()
        {
            ...
            for (int i = 0; i < s.Length; i++)
            {
                ...
                else
                {
                    if (s[i] == 'R')
                    {
                        if (left_l_index % 2 == 1) //even
                        {
                            ans[left_l_index] = count_even;
                            ans[right_r_index] = count_odd;
                        }
                        else
                        {
                            ans[left_l_index] = count_odd;
                            ans[right_r_index] = count_even;
                        }
